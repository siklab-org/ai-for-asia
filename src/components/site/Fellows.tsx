...
export const fellows: Fellow[] = [
  {
    img: "/fellows/Carrisa Tehputri.jpeg",
    name: "Carrisa Tehputri",
    quote: "ASEAN must decide: act independently — or rise as one.",
    city: "Jakarta",
    country: "Indonesia",
    x: 43,
    y: 67,
  ...
  {
    img: "/fellows/Jupiter Cabig Jr.jpg",
    name: "Jupiter D. Cabig Jr.",
    quote: "Government can shape vibrant AI startup ecosystems.",
    city: "Manila",
    country: "Philippines",
    x: 56,
    y: 36,
  ...
  {
    img: "/fellows/Dylan Joseph Gonzales.jpg",
    name: "Dylan Joseph Gonzales",
    quote: "AI is multisectoral — and must be ethical for community.",
    city: "Manila",
    country: "Philippines",
    x: 50,
    y: 40,
  ...
  {
    img: "/fellows/41 Trang Nguyen.jpg",
    name: "Nguyen Thi Huyen Trang",
    quote: "Governance and workforce adaptation must move in parallel.",
    city: "Hanoi",
    country: "Vietnam",
    x: 25,
    y: 24,
  ...
  {
    img: "/fellows/Shine_Min_Kha_photo.jpg",
    name: "Shine Min Kha",
    quote: "Leadership is the key skill of the AI-driven era.",
    city: "Yangon",
    country: "Myanmar",
    x: 10,
    y: 14,
  ...
  {
    img: "/fellows/Ahmad Habibulloh.jpg",
    name: "Ahmad Habibulloh",
    quote: "AI governance must serve communities across ASEAN.",
    city: "Taipei",
    country: "Taiwan",
    x: 12,
    y: 10,
  ...
  {
    img: "/fellows/Hanazel Superal.png",
    name: "Hanazel Superal",
    quote: "Technology should bridge gaps, not widen them.",
    city: "Manila",
    country: "Philippines",
    x: 60,
    y: 42,
  ...
  {
    img: "/fellows/Lee Zhao Yi Charles.jpeg",
    name: "Lee Zhao Yi Charles",
    quote: "Building AI that reflects our shared humanity.",
    city: "Singapore",
    country: "Singapore",
    x: 24,
    y: 57,
  ...
  {
    img: "/fellows/Rustam Shariq Mujtaba.jpg",
    name: "Rustam Shariq Mujtaba",
    quote: "Policy and innovation must evolve together.",
    city: "Singapore",
    country: "Singapore",
    x: 24,
    y: 60,
  ...
  {
    img: "/fellows/Yu Wai Wai Khine.jpeg",
    name: "Yu Wai Wai Khine",
    quote: "Inclusive AI starts with diverse voices.",
    city: "Bangkok",
    country: "Thailand",
    x: 15,
    y: 20,
...
export function flagPinSvg(country: string): string {
  ...
  switch (country) {
    ...
    case "Malaysia":
      return flag(
        '<rect x="3" y="7" width="22" height="10" fill="#CC0001"/><rect x="3" y="8.5" width="22" height="1.25" fill="#fff"/><rect x="3" y="10" width="22" height="1.25" fill="#CC0001"/><rect x="3" y="11.5" width="22" height="1.25" fill="#fff"/><rect x="3" y="13" width="22" height="1.25" fill="#CC0001"/><rect x="3" y="14.5" width="22" height="1.25" fill="#fff"/><rect x="3" y="15.75" width="22" height="1.25" fill="#CC0001"/><rect x="3" y="7" width="8.5" height="7.5" fill="#010066"/><polygon points="7.25,8.5 8,10.5 10,10.5 8.5,11.8 9,14 7.25,12.5 5.5,14 6,11.8 4.5,10.5 6.5,10.5" fill="#FFCC00"/>',
      );
    case "Brunei Darussalam":
      return flag(
        '<rect x="3" y="7" width="22" height="10" fill="#F7E017"/><polygon points="3,9 20,7 25,16 8,17" fill="#fff"/><polygon points="3,15 20,17 25,8 8,7" fill="#000"/>',
      );
    case "Timor Leste":
      return flag(
        '<rect x="3" y="7" width="22" height="10" fill="#DA291C"/><polygon points="3,7 15,12 3,17" fill="#000"/><polygon points="3,7 9,12 3,17" fill="#FFC72C"/><polygon points="6,9.5 7,12.5 10,12.5 7.5,14.5 8.5,17.5 6,15.5 3.5,17.5 4.5,14.5 2,12.5 5,12.5" fill="#fff"/>',
      );
    case "Cambodia":
      return flag(
        '<rect x="3" y="7" width="22" height="10" fill="#00247D"/><rect x="3" y="9" width="22" height="6" fill="#CE1126"/><polygon points="14,9.5 11,11 17,11" fill="#fff"/><rect x="12.5" y="10.5" width="3" height="2.5" fill="#fff"/>',
      );
    default:
      return "";
  }
...
function FlagPin({ country }: { country: string }) {
  ...
  const cn = (paths: React.ReactNode) => (
    ...
    >
      ...
      <g clipPath={`url(#pin-${country})`}>{paths}</g>
      <circle
        cx={14}
        cy={12}
        r={11}
      ...
      />
      <path
        d="M14 24 Q10 18 8 14 Q6 10 8 7 Q10 4 14 4 Q18 4 20 7 Q22 10 20 14 Q18 18 14 24Z"
        fill="none"
  ...
  switch (country) {
    case "Indonesia":
      return cn(
        <>
          <rect x={3} y={7} width={22} height={5} fill="#CE1126" />
          <rect x={3} y={12} width={22} height={5} fill="#fff" />
        </>,
      );
    case "Philippines":
      return cn(
        <>
          <rect x={3} y={7} width={22} height={5} fill="#0038A8" />
          <rect x={3} y={12} width={22} height={5} fill="#CE1126" />
          <polygon points="3,7 14,12 3,17" fill="#fff" />
        </>,
      );
    case "Vietnam":
      return cn(
        <>
          <rect x={3} y={7} width={22} height={10} fill="#DA251D" />
          <polygon
            points="14,8 15.5,11.5 19,11.5 16.5,14 17.5,17.5 14,15.5 10.5,17.5 11.5,14 9,11.5 12.5,11.5"
            fill="#FFFF00"
          />
        </>,
      );
    case "Myanmar":
      return cn(
        <>
          <rect x={3} y={7} width={22} height={3.33} fill="#FECB00" />
          <rect x={3} y={10.33} width={22} height={3.33} fill="#34B233" />
          <rect x={3} y={13.66} width={22} height={3.34} fill="#EA2839" />
        </>,
      );
    case "Taiwan":
      return cn(
        <>
          <rect x={3} y={7} width={22} height={10} fill="#FE0000" />
          <rect x={3} y={7} width={11} height={5} fill="#000095" />
          <circle cx={8.5} cy={9.5} r={2.5} fill="#fff" />
          <path
            d="M8.5 7.5 L9 9 L10.5 9 L9.5 10 L10 11.5 L8.5 10.5 L7 11.5 L7.5 10 L6.5 9 L8 9 Z"
            fill="#fff"
          />
        </>,
      );
    case "Singapore":
      return cn(
        <>
          <rect x={3} y={7} width={22} height={5} fill="#ED2939" />
          <rect x={3} y={12} width={22} height={5} fill="#fff" />
          <circle cx={8} cy={9.5} r={2.5} fill="#fff" />
          <circle cx={8} cy={9.5} r={1.8} fill="#ED2939" />
        </>,
      );
    case "Thailand":
      return cn(
        <>
          <rect x={3} y={7} width={22} height={2} fill="#00247D" />
          <rect x={3} y={9} width={22} height={2} fill="#fff" />
          <rect x={3} y={11} width={22} height={2} fill="#CE1126" />
          <rect x={3} y={13} width={22} height={2} fill="#fff" />
          <rect x={3} y={15} width={22} height={2} fill="#00247D" />
        </>,
      );
    default:
      return null;
      ...
      <div className="relative aspect-[3/4] rounded-2xl overflow-hidden border border-white/10 bg-white/[0.03] shadow-xl">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 md:p-5">
          ...
          <div className="flex items-center gap-1.5 mt-1">
            ...
            <p className="text-[11px] md:text-xs text-white/60 font-light tracking-wide">
  ...
  useEffect(() => {
    ...
    if (!firstCard) {
      ...
      requestAnimationFrame(() => {
        ...
        const w = Math.max(
          0,
          (el.clientWidth - fc.offsetWidth) / 2 - fc.offsetLeft,
        );
        setSpacerWidth(w);
        el.scrollLeft = 0;
      });
    ...
    const w = Math.max(
      0,
      (el.clientWidth - firstCard.offsetWidth) / 2 - firstCard.offsetLeft,
    );
    setSpacerWidth(w);
    el.scrollLeft = 0;
  }, []);
