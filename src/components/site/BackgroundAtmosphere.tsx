...
export function BackgroundAtmosphere() {
  const { scrollY } = useScroll();
  const fadeOut = useTransform(scrollY, [0, 3000, 12000, 15000], [1, 1, 0.3, 0.15], { clamp: true });
  ...
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
      ...
      <motion.div
        className="absolute inset-0 bg-gradient-to-t from-background via-transparent to-background pointer-events-none"
