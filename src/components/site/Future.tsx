...
import f1 from "@/assets/scraped/future1.png";
import f2 from "@/assets/scraped/future2.png";
import f3 from "@/assets/scraped/future3.png";

const items = [
  { img: f1, title: "Expand", desc: "Across all 10 ASEAN nations." },
  { img: f2, title: "Deepen", desc: "Industry & academic partnerships." },
  { img: f3, title: "Sustain", desc: "Year-round alumni innovation." },
];
